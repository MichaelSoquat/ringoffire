...
export class GameInfoComponent implements OnInit, OnChanges {
  cardAction = [
    ...
    { title: 'Thumbmaster', description: 'Ask a question. If answer is right: Don´t drink. If it´s not: Drink!' },
    { title: 'Men', description: 'All men drink.' },
    { title: 'Quizmaster', description: 'Ask a question. Everyone who cannot answer right has to drink' },
